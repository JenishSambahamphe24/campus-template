...
import ContactDetailsList from "./Screens/cmsScreen/cms-components/cms-contactDetails/components/ContactDetailsList.jsx";
import AddContactDetails from "./Screens/cmsScreen/cms-components/cms-contactDetails/components/AddContactDetails.jsx";
...
import EditContactDetails from "./Screens/cmsScreen/cms-components/cms-contactDetails/components/EditContactDetails.jsx";
  ...
  createRoutesFromElements(
    <>
      <Route path="/" element={<App />}>
        ...
        <Route
          index={true}
          path="/message-from-campus_chief"
          element={<CampusChiefMessage />}
        />
      </Route>
      ...
      <Route element={<PrivateRoutes />}>
        <Route path="/admin" element={<AdminLayout />}>
          ...
          <Route
            index={true}
            path="editPublication/:pubId"
            element={<EditPublication />}
          />
          <Route
            index={true}
            path="addCategory"
            element={<PublicationCategory />}
          />
