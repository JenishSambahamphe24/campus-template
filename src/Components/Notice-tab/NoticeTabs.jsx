...
import {
  ...
  getAllpublication,
} from "../../Screens/cmsScreen/cms-components/cms-publication/publicationApi";
  ...
  return (
    ...
    >
      <Grid
        ...
        className="relative rounded-l-lg border-2 border-[#1169bf] h-[27rem]"
      >
        <h1 className="bg-[#1169bf] text-white text-lg text-center font-bold uppercase py-2">
          Latest Notices
        </h1>
      ...
      <Grid
        ...
        className={`relative border-2 border-[#1169bf] ${
          isMobile ? "h-[37rem]" : "h-[27rem]"
        }`}
      >
        <h1 className="bg-[#1169bf] text-white text-lg text-center font-bold uppercase py-2">
          Offered Programs
        ...
        >
          {allPrograms.length > 0 ? (
            ...
            <h1 className="ml-72 text-sm">No any contents !!</h1>
          )}
          <Link
            className="w-full flex justify-end mb-1 absolute bottom-0 right-1"
            to="/program-list"
      ...
      <Grid
        ...
        className="relative border-2 rounded-r-lg  border-[#1169bf] h-[27rem]"
      >
        <h1 className="bg-[#1169bf] text-white text-lg text-center font-bold uppercase py-2">
          latest news & events
        </h1>
            ...
            news
              ...
              .map((item, index) => (
                <Link
                  ...
                  key={index}
                  className="flex border-[1px] rounded-sm items-center "
                >
