        ...
        <nav className="relative bg-white shadow ">
            <div className=" py-1 pb-0 mx-auto">
                <div className="flex  flex-col md:flex-row md:justify-between md:items-center">
                    <div className="px-4 lg:px-20  h-full items-center mx-auto flex justify-between w-full">
                        <Link className="w-full flex items-center" to="/">
                            ...
                            <div className="ml-2 lg:ml-4 flex flex-col justify-center">
                                <h1 className="text-lg lg:text-2xl tracking-normal"> {collegeName} </h1>
                ...
                {/* Mobile Menu */}
                <div
                    className={`${isOpen ? 'relative' : 'absolute'} bg-[#0368b0] inset-x-0 z-20 w-full px-3 pt-0 pb-4 transition-all duration-200 ease-in-out  top-54  md:mt-0 md:p-0 md:top-0 md:relative md:bg-transparent md:w-auto md:opacity-100 md:translate-x-0 md:flex md:items-center ${isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full'
                        }`}
                >
