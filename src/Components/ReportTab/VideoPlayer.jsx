    ...
    <Grid container direction="row" rowGap="10px" columnGap="15px">
      ...
      >
        <Grid className=" text-white" sm={12}>
          <h1 className="inline-block px-1  bg-[#1169bf]  text-md">
            {" "}
            Image Gallery
          </h1>
        </Grid>
        {images.length > 0 ? (
          images
            ...
            .map((item, index) => (
              <Grid key={index} mx={isMobile ? "auto" : ""} item xs={10} sm={3}>
                <Link
                  to={`/galleryGrid/${item.id}`}
                  className="group relative m-0 flex h-[180px] w-full rounded-xl  ring-gray-900/5 sm:mx-auto sm:max-w-lg"
                >
                  ...
                  <div className="absolute w-full bottom-[-10px] z-10 bg-[#F36710] rounded-b-lg  p-1">
                    <h1 className="font-serif text-md font-bold text-center tracking-tighter line-clamp-1 text-white">
                      {item.galleryName}
                    </h1>
                  </div>
                </Link>
          ...
          <Grid xs={12} className="content-center min-h-[150px] ">
            <h1 className="text-md text-center">No Images Uploaded yet!</h1>
          </Grid>
        )}
      </Grid>
      <Grid
      ...
      >
        ...
        {videos.length > 0 ? (
          ...
          <Grid xs={12} className="min-h-[150px] content-center">
      ...
      <div className="w-full mt-4 flex justify-end">
        ...
        >
          <Link to="/gallery">
            <Typography>More Gallery</Typography>
          </Link>
          <svg
