    ...
    <Box className="py-4 px-4 sm:px-6 md:px-8">
      <Grid container spacing={2} sx={{ minHeight: { xs: 'auto', lg: '400px' } }}>
        <Grid item xs={12} sm={6} md={6} lg={2.5} order={{ xs: 2, sm: 2, md: 2, lg: 1 }}>
          <fieldset className="flex flex-col border-2 border-[#0368B0] h-full justify-between text-xl rounded-lg">
            <div className="flex flex-col gap-1 text-sm">
              <h1 className="bg-[#0368b0] text-lg font-semibold text-white py-2 text-center border-b-2">
                Software Application under Implementation
              </h1>
              <div className="flex flex-col space-y-4 px-4 py-2">
                {allLinks.length >= 1 ? (
                  allLinks.map((item, index) => (
                    <div className="bg-[#F36710] p-3 text-md" key={index}>
                      <a
                        href={item.url}
                        download
        ...
        <Grid item xs={12} sm={6} md={6} lg={2.5} order={{ xs: 3, sm: 3, md: 3, lg: 3 }}>
          <fieldset className="flex border-2 border-[#0368B0] flex-col h-full justify-between text-xl rounded-lg px-4">
