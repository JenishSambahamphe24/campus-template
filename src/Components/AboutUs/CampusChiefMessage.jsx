                ...
                data ? (
                    <>
                        <div className=" w-full flex justify-center mx-auto ">
                            <img
                                src={chiefImage ? `${IMAGE_URL}/team/${chiefImage}` : defaultImage}
                    ...
                    <Grid item sm={12}>
                        <h1 className='text-center text-red-900 mt-8'>No data uploaded yet. please login to the cms and add campus chief's message</h1>
                    </Grid>
                )
            }
...
export default CampusChiefMessage