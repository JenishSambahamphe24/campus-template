...
function EditGallery() {
    ...
    const fetchData = async () => {
      try {
        ...
        setFormData((prev) => ({
          ...
          // Normalize API response to string for dropdown
          isIntroVideo:
            gallery.isIntroVideo === true ||
            gallery.isIntroVideo === "true" ||
            gallery.isIntroVideo === 1
              ? "true"
              : gallery.isIntroVideo === false ||
                gallery.isIntroVideo === "false" ||
                gallery.isIntroVideo === 0
              ? "false"
              : "",
        }));
  ...
  const handleSubmit = async (e) => {
    ...
    updatedData.append(
      "isIntroVideo",
      formData.isIntroVideo === "true" ? true : false
    );
        ...
        <form onSubmit={handleSubmit}>
            ...
            <Grid item sm={12} md={3}>
              <FormControl size="small" fullWidth>
                ...
                <Select
                  ...
                  onChange={handleChange}
                  label="Is this introductory video?"
                  size="small"
                  variant="standard"
                >
            ...
            <Grid item sm={12} md={4}>
              ...
              <FileDroppable
                ...
                onImagesChange={(updatedFiles) =>
                  handleImageChange(updatedFiles, "thumbnailImage")
                }
              />
              {fetchedThumbnail && (
                <div
                ...
                >
                  <img
                    src={`${IMAGE_URL}/thumb/${fetchedThumbnail}`}
                    alt="Fetched"
                    style={{
                      width: "100%",
                      height: "100%",
              ...
              {images.map((item, index) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="bg-white absolute top-0 p-[2px] rounded-md right-0"
                  >
                    <IoCloseSharp />
                  </button>
                </Grid>
          ...
          <Grid item sm={12} gap="20px" className="flex justify-end mt-2">
            <Button size="small" color="error" variant="outlined">
              {" "}
              <Link to="/admin/viewGallery"> cancel</Link>{" "}
            </Button>
