...
function Publication() {
    ...
    const paginatedItems = allPublication.slice(indexOfFirstItem, indexOfLastItem);
    ...
    const NoPublicationsMessage = () => (
        <Grid item xs={12} className="flex flex-col items-center justify-center py-6">
            <div className="bg-blue-50 rounded-lg p-6 text-center max-w-md shadow-md">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-2">No Publications Found</h3>
                <p className="text-gray-600">Please check back later or contact the admin to upload new publications.</p>
            </div>
        </Grid>
    );
