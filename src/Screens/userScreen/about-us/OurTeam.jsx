...
function OurTeam() {
    ...
    const [activeTab, setActiveTab] = useState("committeMember");
        ...
        <Grid container className='px-2 md:px-6 lg:px-9 py-8'>
            ...
            <Grid item xs={12}>
                <Tabs value={activeTab}>
                    ...
                    <TabsBody>
                        <TabPanel style={{ marginTop: '20px', padding: '0' }} value="committeMember">
                            <Grid minHeight='250px' gap='10px' container mx='auto' mb='1.5rem' padding='10px 0px'>
                                {allTeamMember
                                    ?.filter(item => item.category === 'committeMember')
                        ...
                        <TabPanel style={{ marginTop: '20px', padding: '0' }} value="staff">
