...
function OurTeam() {
    ...
    return (
        <Grid container className='px-20 py-6'>
            <h1 className='text-center w-full text-2xl font-bold'>Our team</h1>
            <Grid container spacing={2} mx='auto' mb='1.5rem' padding='0px 30px' sx={{ gridTemplateColumns: 'repeat(4, 1fr)' }}>
                <Grid item sm={12}>
                    <h2 className="text-xl  text-gray-900 ">Committee Members</h2>
                </Grid>
                {allTeamMember?.filter(item => item.category === 'committeMember').sort((a, b) => a.index - b.index).map((item, index) => (
                    <Grid item md={2} key={index} sx={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <Grid container spacing={2} mx='auto' mb='1.5rem' padding='10px 30px' sx={{ gridTemplateColumns: 'repeat(4, 1fr)' }}>
                <Grid item sm={12}>
                    <h2 className="text-xl  text-gray-900 ">Staffs</h2>
                </Grid>
